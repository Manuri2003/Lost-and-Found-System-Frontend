          ...
          <Col md={4}>
            <Card className="shadow-sm mb-3 h-100 bg-dark text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>
              <Card.Body>
                ...
                <Card.Text className="text-white">
                  <strong>Name:</strong> Manuri Pabara | Solo creations<br />
                  <strong>Email:</strong> <a href="mailto:kjtmanuripabara@gmail.com" className="text-white">kjtmanuripabara@gmail.com</a><br />
                  <strong>Phone:</strong> 0760323953<br />
